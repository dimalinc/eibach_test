...
public class newItem {
    ...
    private List<newItemAttribute> newItemAttributeList;
    ...
    public List<newItemAttribute> getNewItemAttributeList() {
        return newItemAttributeList;
    }

    public void setNewItemAttributeList(List<newItemAttribute> newItemAttributeList) {
        this.newItemAttributeList = newItemAttributeList;
    }
